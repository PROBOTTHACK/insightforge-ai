...
export function DynamicChart({ widget }: { widget: ChartWidget }) {
  ...
  return (
    <article className="min-h-80 rounded-lg border border-slate-200 bg-white p-4 dark:border-slate-800 dark:bg-slate-900 md:col-span-2">
      ...
      {widget.insight ? <p className="mt-3 rounded-md bg-slate-50 px-3 py-2 text-sm text-slate-600 dark:bg-slate-800 dark:text-slate-300">{widget.insight}</p> : null}
    </article>
  );
}
